...
class AmphibianViewModel : ViewModel() {
    ...
    // List of amphibian objects
    private val _amphibians = MutableLiveData<List<Amphibian>>()
    val amphibians: LiveData<List<Amphibian>> = _amphibians

    // The selected amphibian whose details are displayed
    private val _amphibian = MutableLiveData<Amphibian>()
    val amphibian = _amphibian

    /**
     * Gets the list of amphibians from the API service and sets the status
     */
