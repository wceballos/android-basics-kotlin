...
/**
 * A public interface that exposes the Amphibian API methods.
 */
...
/**
 * A public API singleton to expose a lazy-initialized [AmphibianApiService]
 */
object AmphibianApi {
    val retrofitService: AmphibianApiService
        by lazy { retrofit.create(AmphibianApiService::class.java) }
}
